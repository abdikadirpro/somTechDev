...
function SignOut() {
  ...
  return (
    <div className={darkMode ?"flex justify-center items-center min-h-screen bg-gray-100 dark:bg-gray-900 px-4 py-12":"flex justify-center items-center min-h-screen py-12 dark:bg-gray-900 px-4"}>
